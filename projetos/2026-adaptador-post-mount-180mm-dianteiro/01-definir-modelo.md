...
1 adaptador dianteiro Post Mount para Post Mount 180mm (Shimano SM-MA-F180P/P2 ou Absolute) para suspensao da Gonew Endorphine 6.3
...
- Do perfil (equipamento, local, uso) o que pesa nesta compra:
- Perguntas decisivas respondidas:
- Suposicoes adotadas (sem resposta minha, a IA propos o padrao):
...
- Tipo/modelo escolhido para pesquisar:
