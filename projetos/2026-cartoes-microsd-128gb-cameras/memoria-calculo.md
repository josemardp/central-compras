...
- nota_ajustada abaixo do gate (0.0 < 4.3)
- avaliacoes insuficientes (0 < 300)
- categoria exige vendedor oficial
...
- custo total desta cotacao: R$ 893,16
- menor custo total entre os elegiveis: R$ 0,00
- valor = R$ 0,00 / R$ 893,16 = **1.000**
...
| risco | 0.559 | 0.2 | sim | 0.111800 |
| aderencia | -- | 0.15 | nao (sem dado) | 0 |
| conveniencia | -- | 0.1 | nao (sem dado) | 0 |
| soma dos que entraram | | 0.450000 | | **0.361800** |
| **renormalizado: 0.361800 / 0.450000 x 100** | | | | **80.4** |

Confianca: **45%** do peso do score apoiado em dado real.

Score publicado: **0** (cortado no gate, nao os 80.4 acima).
